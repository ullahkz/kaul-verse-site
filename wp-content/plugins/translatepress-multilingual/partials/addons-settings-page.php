...
<div id="trp-settings-page" class="wrap">
    ...
    $trp_addons_listing->items = array(
        array(  'slug' => 'tp-add-on-seo-pack/tp-seo-pack.php',
            ...
            //[utm48]
            'doc_url' => 'https://translatepress.com/docs/addons/seo-pack/?utm_source=tp-addons&utm_medium=client-site&utm_campaign=seo-pack-addon',
        ),
        array(  'slug' => 'tp-add-on-extra-languages/tp-extra-languages.php',
            ...
            //[utm49]
            'doc_url' => 'https://translatepress.com/docs/addons/multiple-languages/?utm_source=tp-addons&utm_medium=client-site&utm_campaign=multiple-languages-addon',
        ),
    );
    ...
    $trp_addons_listing->items = array(
        array(  'slug' => 'tp-add-on-deepl/index.php',
            ...
            //[utm50]
            'doc_url' => 'https://translatepress.com/docs/addons/deepl-automatic-translation/?utm_source=tp-addons&utm_medium=client-site&utm_campaign=deepl-addon',
        ),
        array(  'slug' => 'tp-add-on-automatic-language-detection/tp-automatic-language-detection.php',
            ...
            //[utm51]
            'doc_url' => 'https://translatepress.com/docs/addons/automatic-user-language-detection/?utm_source=tp-addons&utm_medium=client-site&utm_campaign=language-detection-addon',
        ),
        array(  'slug' => 'tp-add-on-translator-accounts/index.php',
            ...
            //[utm52]
            'doc_url' => 'https://translatepress.com/docs/addons/translator-accounts/?utm_source=tp-addons&utm_medium=client-site&utm_campaign=translator-account-addon',
        ),
        array(  'slug' => 'tp-add-on-browse-as-other-roles/tp-browse-as-other-role.php',
            ...
            //[utm53]
            'doc_url' => 'https://translatepress.com/docs/addons/browse-as-role/?utm_source=tp-addons&utm_medium=client-site&utm_campaign=browse-as-user-addon',
        ),
    ...
    $trp_addons_listing->items = array(
        array(  'slug' => 'profile-builder/index.php',
            ...
            'icon' => 'pb_logo.jpg',
            // [utm75]
            'doc_url' => 'https://www.cozmoslabs.com/wordpress-profile-builder/?utm_source=tp-addons&utm_medium=client-site&utm_campaign=tp-pb-upsell',
        ...
        array(  'slug' => 'paid-member-subscriptions/index.php',
            ...
            'icon' => 'pms_logo.jpg',
            // [utm76]
            'doc_url' => 'https://www.cozmoslabs.com/wordpress-paid-member-subscriptions/?utm_source=tp-addons&utm_medium=client-site&utm_campaign=tp-pms-upsell',
        ...
        array( 'slug' => 'wp-webhooks/wp-webhooks.php',
            ...
            'icon' => 'wha_logo.png',
            //[utm77]
            'doc_url' => 'https://wp-webhooks.com/?utm_source=tp-addons&utm_medium=client-site&utm_campaign=tp-wpwh-upsell',
